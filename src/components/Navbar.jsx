    ...
    top-0 z-20 bg-primary `}>
      ...
      items-center max-w-7x1 mx-auto'>
        <Link to="/" className='flex items-center gap-2' onClick={() => {
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Muhammed <span className='sm:block hidden'>| Safvan</span></p>
        </Link>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          ...
          <div className={`${!toggle ? "hidden" : "flex"} p-6 black-gradient top-20 right-0 z-10
          absolute mx-4 my-2 min-w-[140px] rounde-x1`}>
